...
class FullBodyPoseEmbedder(object):
    ...
    def _normalize_pose_landmarks(self, landmarks):
        ...
        pose_center = self._get_pose_center(landmarks)      # 将两臀之间的点坐标作为姿态的中心
        landmarks -= pose_center                            # The first step of Normalizatin

        # Normalize scale.
        pose_size = self._get_pose_size(landmarks, self._torso_size_multiplier)
        landmarks /= pose_size                              # The second step of Normalization
